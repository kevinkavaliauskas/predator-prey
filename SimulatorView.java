...
public class SimulatorView extends JFrame {
    ...
    public void showStatus(int step, Field field, Weather currentWeather) {
            ...
            for (int col = 0; col < field.getWidth(); col++) {
                ...
                if (animal != null) {
                    ...
                    if (animal instanceof Animal) {
                        isInfected = ((Animal) animal).getInfectedStatus();
                    }
                    fieldView.drawMark(col, row, getColor(animal.getClass()), isInfected);
                } else {
        ...
        generalStats.setText(
                POPULATION_PREFIX + stats.getPopulationDetails(field) + WEATHER_PREFIX + currentWeather.getWeather());
        fieldView.repaint();
    }
    ...
    private class FieldView extends JPanel {
         ...
         */
        public void drawMark(int x, int y, Color color, boolean isInfected) {
            g.setColor(color);
            g.fillRect(x * xScale, y * yScale, xScale - 1, yScale - 1);
            if (isInfected) {
                g.setColor(Color.BLACK);
                g.fillRect(x * xScale + 1, y * yScale + 1, xScale - 3, yScale - 3);
            }
        }
